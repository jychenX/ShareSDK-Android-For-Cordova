    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            ...
            case MSG_AUTHORIZE: {
                ...
                String name = ShareSDK.platformIdToName(platform);
                Platform plat = ShareSDK.getPlatform(name);
                plat.setPlatformActionListener(new CordovaPlatformListener(callbackListener));
            ...
            case MSG_SHARE: {
                ...
                try {
                    ...
                    new CordovaPlatformListener(callbackListener).onError(plat, Platform.ACTION_SHARE, t);
                }
            }
            break;
            case MSG_ONEKEY_SAHRE: {
                ...
                oks.setCallback(new CordovaPlatformListener(callbackListener));
                oks.show(context);
            }
            break;
